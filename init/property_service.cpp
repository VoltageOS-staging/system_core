...
// Generates a unique, deterministic 64-char hex SHA-256-like digest per build
...
void LoadVbMetaOverrides() {
    ...
    // Provide a dummy standard size if the partition couldn't be read in early init
    ...
    // Fallback spoofing if original vbmeta digest is missing
